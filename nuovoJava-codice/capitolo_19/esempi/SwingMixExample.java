...
public class SwingMixExample {
    ...
    class LabelsPanel extends JPanel {
        ...
        LabelsPanel() {
            ...
            JLabel imageLabel = new JLabel("Label with EJE logo", new ImageIcon("img/eje.png"), JLabel.CENTER);
            add(toolTipLabel);
            add(imageLabel);
        }
    }
    ...
    class ButtonsPanel extends JPanel {
        ...
        ButtonsPanel() {
            ...
            final JButton imageButton = new JButton(new ImageIcon("img/clock.png"));
            imageButton.setRolloverIcon(new ImageIcon("img/clock-red.png"));
            add(button);
            add(imageButton);
