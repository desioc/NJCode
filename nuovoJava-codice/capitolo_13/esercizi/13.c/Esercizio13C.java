...
public class Esercizio13C {

    public static void main(String args[]) {
        List<Citta> listaCitta = getCitta();
        System.out.println("Città di mare: " + filtraCitta(listaCitta, Esercizio13C::isDiMare));
        listaCitta = getCitta();
        System.out.println("Città capoluogo: " + filtraCitta(listaCitta, Esercizio13C::isCapoluogo));
        listaCitta = getCitta();
    }
